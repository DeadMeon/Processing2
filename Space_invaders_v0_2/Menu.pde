...
{
  // attributs
  int x, optionB1, optionB2, optionB3, optionB4, optionB5, optionB6, optionB7, optionB8, optionB9, optionB10, optionB11, optionBRetour;
  ...
  Menu() {
    ...
    param.choixJoueur = 0; // 0 = Normal ; 1= Vintage
  }
  ...
  void menu1() 
  {
    ...
    textSize(14);
    text("v0.2", width/2+250, height/3+50);
    textSize(24);
  ...
  void option() 
  {
    ...
    */
    ...
    text("Reset", width/2, 12*height/18);
  }
